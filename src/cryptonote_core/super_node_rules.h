...
namespace super_nodes {
  ...
  constexpr size_t   MIN_VOTES_TO_KICK_SUPER_NODE   = 7;
...
// return: UINT64_MAX if (num_contributions > the max number of contributions), otherwise the amount in quorax atomic units
